...
// Si NO ha iniciado sesión, lo mandamos al login público
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="nav navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#productos">Productos Destacados</a>
                    </li>
    ...
    <section id="equipo" class="container mt-4 text-center">
    ...
    <section id="contacto" class="container mt-4">
        ...
        <h2>Contacto</h2>
        <p>Si deseas conocer más sobre LiveTheFe, solicitar una demostración o recibir soporte del sistema, escríbenos y 
