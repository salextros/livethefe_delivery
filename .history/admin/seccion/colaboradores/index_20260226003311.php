...
<td>
  <a class="btn btn-info me-2" href="editar.php?txtID=<?php echo $value["ID"];?>" role="button">Editar</a>
  <a class="btn btn-danger" href="index.php?txtID=<?php echo $value["ID"];?>" role="button">Borrar</a>
</td>
