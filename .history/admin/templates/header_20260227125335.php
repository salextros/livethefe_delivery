...
$url_base = "http://localhost/homework_sena/thelivefe_1/";
        ...
        <header>
            ...
            <nav class="navbar navbar-expand navbar-light bg-light">
                <div class="nav navbar-nav">
                    ...
                    <a class="nav-item nav-link" href="<?php echo $url_base;?>seccion/productos">Produtos</a>
                    ...
                    <a class="nav-item nav-link text-success fw-bold" 
   href="http://localhost/homework_sena/thelivefe_1/" 
